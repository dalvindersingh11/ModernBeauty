 ...
 return (
  <SafeAreaView style={Styles.container}>
   <View style={Styles.contentWrapper}>
    ...
    <View style={Styles.card}>
     <TouchableOpacity onPress={() => navigation?.navigate('ManageSubscription')} style={Styles.row}>
     ...
     <TouchableOpacity onPress={() => navigation?.navigate('HelpSupport')} style={Styles.row}>
      ...
      <Text allowFontScaling={true} style={Styles.optionText}>
       Help & Support
        ...
        <TouchableOpacity onPress={() => navigation?.navigate('TermsPolicies')} style={Styles.row}>
